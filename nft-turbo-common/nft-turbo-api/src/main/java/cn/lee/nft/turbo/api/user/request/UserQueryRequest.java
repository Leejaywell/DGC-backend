...
import cn.lee.nft.turbo.api.user.request.condition.UserIdQueryCondition;
import cn.lee.nft.turbo.api.user.request.condition.UserPhoneAndPasswordQueryCondition;
import cn.lee.nft.turbo.api.user.request.condition.UserPhoneQueryCondition;
import cn.lee.nft.turbo.api.user.request.condition.UserQueryCondition;
