package cn.lee.nft.turbo.collection.domain.service.impl;

import cn.lee.nft.turbo.api.collection.constant.CollectionInventoryModifyType;
import cn.lee.nft.turbo.api.collection.request.CollectionCreateRequest;
import cn.lee.nft.turbo.api.collection.request.CollectionModifyInventoryRequest;
import cn.lee.nft.turbo.api.collection.request.CollectionModifyPriceRequest;
import cn.lee.nft.turbo.api.collection.request.CollectionRemoveRequest;
import cn.lee.nft.turbo.api.collection.response.CollectionInventoryModifyResponse;
import cn.lee.nft.turbo.collection.domain.entity.Collection;
import cn.lee.nft.turbo.collection.domain.entity.CollectionInventoryStream;
import cn.lee.nft.turbo.collection.domain.entity.CollectionSnapshot;
import cn.lee.nft.turbo.collection.domain.entity.CollectionStream;
import cn.lee.nft.turbo.collection.domain.entity.convertor.CollectionConvertor;
import cn.lee.nft.turbo.collection.domain.request.HeldCollectionCreateRequest;
import cn.lee.nft.turbo.collection.domain.response.CollectionConfirmSaleResponse;
import cn.lee.nft.turbo.collection.domain.service.CollectionService;
import cn.lee.nft.turbo.collection.exception.CollectionException;
import cn.lee.nft.turbo.collection.facade.request.CollectionCancelSaleRequest;
import cn.lee.nft.turbo.collection.facade.request.CollectionConfirmSaleRequest;
import cn.lee.nft.turbo.collection.facade.request.CollectionTrySaleRequest;
import cn.lee.nft.turbo.collection.infrastructure.mapper.CollectionInventoryStreamMapper;
import cn.lee.nft.turbo.collection.infrastructure.mapper.CollectionMapper;
import cn.lee.nft.turbo.collection.infrastructure.mapper.CollectionSnapshotMapper;
import cn.lee.nft.turbo.collection.infrastructure.mapper.CollectionStreamMapper;
...
import static cn.lee.nft.turbo.base.response.ResponseCode.DUPLICATED;
import static cn.lee.nft.turbo.collection.exception.CollectionErrorCode.*;
